...
function getRecords() {
    ...
    filterstr="flag=1 AND office="+officename;
...
///////////////
controllerstatus.drvclr.forEach(function(entry){
var ofinde=entry.indexOf(officename);
if (ofinde == -1) {controllerstatus.drvclr.splice(ofinde, 1);}

});
controllerstatus.drvengag.forEach(function(entry){
var ofindeg=entry.indexOf(officename);
if (ofindeg == -1) {controllerstatus.drvengag.splice(ofindeg, 1);}
