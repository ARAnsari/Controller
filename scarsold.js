...
function addElement() {
    ...
    c.innerHTML = "Via " + numofvia + ": <input style='height: 25px;width: 99%;' onclick='pcstrgen(this.id)' type='text' id='autocomplete" + b + "' name='" + b + "'/ >";
    a.appendChild(c);
...
function cleanup() {
    ...
    if ("" == telcust) {
alert("please put your contact and press 'Confirm' again");
}
...
function manualfare() {
    0 != calculatedfare && (calculatedfare = prompt("Please enter manual fare"), document.getElementById("total").innerHTML="Cost is &pound"+ calculatedfare)
}
function noteme() {
...
function basejob(){
baseobj={};
baseobj.address="base";

switch(officename) {
    case 'KNG':
        base = new google.maps.LatLng(51.414026, -0.301214);
baseobj.lat=51.414026;
baseobj.lon=-0.301214;
baseobj.postcode="KT2 5DS";
        break;
    case 'NBN':
        base = new google.maps.LatLng(51.412455, -0.284094);
baseobj.lat=51.412455;
baseobj.lon=-0.284094;
baseobj.postcode="KT2 7AZ";
        break;
    case 'TOT':
        base = new google.maps.LatLng(51.433416, -0.163268);
baseobj.lat=51.433416;
baseobj.lon=-0.163268;
baseobj.postcode="SW17 7EN";
        break;
    case 'SRB':
        base = new google.maps.LatLng(51.392205, -0.303295);
baseobj.lat=51.392205;
baseobj.lon=-0.303295;
baseobj.postcode="KT6 6BZ";
        break;
    case 'WTP':
        base = new google.maps.LatLng(51.381303, -0.245261);
baseobj.lat=51.381303;
baseobj.lon=-0.245261;
baseobj.postcode="KT4 7NB";
        break;
    case 'NBT':
        base = new google.maps.LatLng(51.648594, -0.173364);
baseobj.lat=51.648594;
baseobj.lon=-0.173364;
baseobj.postcode="EN5 1QT";
        break;
    default:
...
function basejobfrom(){bookingloc[0]=baseobj;document.getElementById("autocomplete").value="base";calcRoute();}
function basejobto(){bookingloc[1]=baseobj;document.getElementById("autocomplete1").value="base";calcRoute();}
